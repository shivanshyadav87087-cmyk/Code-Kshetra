...
export const SUPPORTED_LANGUAGES = [
  { id: 'cpp', name: 'C++', label: 'C++', monacoLang: 'cpp', icon: '⚡' },
  { id: 'python', name: 'Python 3', label: 'Python 3', monacoLang: 'python', icon: '🐍' },
  { id: 'java', name: 'Java', label: 'Java', monacoLang: 'java', icon: '☕' },
  { id: 'javascript', name: 'JavaScript', label: 'JavaScript', monacoLang: 'javascript', icon: '💛' },
  { id: 'typescript', name: 'TypeScript', label: 'TypeScript', monacoLang: 'typescript', icon: '💙' },
  { id: 'go', name: 'Go', label: 'Go', monacoLang: 'go', icon: '🐹' }
];
